...
class PeriodDurationView extends StatefulWidget {
  final OnboardingViewModel viewModel;

  const PeriodDurationView({super.key, required this.viewModel});

  @override
  State<PeriodDurationView> createState() => _PeriodDurationViewState();
}

class _PeriodDurationViewState extends State<PeriodDurationView> {
  ...
  void initState() {
    super.initState();
    _currentValue = widget.viewModel.periodDuration;
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Count the number of days of active bleeding.',
                    ...
                    Center(
                      child: OutlinedButton.icon(
                        onPressed: () {
                          setState(() {
                            _currentValue = 5;
                            final targetOffset = (5 - minDays) * itemWidth;
                        ...
                        label: const Text('Not sure? 5 days is average'),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        widget.viewModel.setPeriodDuration(_currentValue);
